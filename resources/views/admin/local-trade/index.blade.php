    ...
    <div class="row mt-5 m-0">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="col">
                    <ul>
                        <li class="active"><a href="{{ route('admin.localtrade.request.index') }}">All <span class="count">({{$data->count()}})</span></a></li>

                    </ul>
                </div>
                <div class="col-auto">
                    <form action="{{ route('admin.localtrade.request.index') }}">
                    <div class="row g-3 align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary">Search Enquiries</button>
                        </div>
                    </div>
                    </form>
                </div>
