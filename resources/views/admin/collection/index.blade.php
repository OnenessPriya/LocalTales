    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row align-items-center justify-content-between">
                <div class="col">
                    <ul>
                        <li class="active"><a href="{{ route('admin.collection.index') }}">All <span class="count">({{$col->count()}})</span></a></li>
                        {{-- @php
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.collection.data.csv.store')}}" enctype="multipart/form-data" id="fileCsvUploadForm">
                        @csrf
                        ...
                        <p><a href="{{URL::to('/')}}/admin/csvexample/collection.xlsx" target="_blank">
...
@push('scripts')
    ...
    $('.sa-remove').on("click",function(){
        ...
        function(isConfirm){
          if (isConfirm) {
            window.location.href = "collection/"+id+"/delete";
            } else {
