...
<section class="sectionCard">
    <div class="search__filter">
        ...
        <div class="col-auto">
            <form action="{{ route('business.market-order.index')}}" method="GET">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="row__action">
                        <a href="{{ route('business.market-order.view', $item->id) }}">View</a>
                    </div>
                </td>
                <td>
                ...
                <td>
                    ...
                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                        <a href="{{ route('business.market-order.status', [$item->id, 1]) }}" type="button" class="btn btn-outline-primary btn-sm {{($item->status == 1) ? 'active' : ''}}">New</a>
