...
<section>
    <div class="row">
        <div class="col-sm-8">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <h3 class="text-muted">{{ $coupon->coupon_code }}</h3>
                            <h6>{{ $coupon->name }}</h6>
                        </div>
                        <div class="col-md-4 text-end">
                            @if ($coupon->end_date < \Carbon\Carbon::now() )
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="">
                                ...
                                <tr>
                                    ...
                                    <td>{{$coupon->max_time_of_use}}</td>
                                </tr>
                                <tr>
                                    <td class="text-muted">Max time usage for single user</td>
                                    <td>{{$coupon->max_time_one_can_use}}</td>
                                </tr>
                                <tr>
                                    <td class="text-muted">No of usage</td>
                                    <td>{{$coupon->no_of_usage}}</td>
                                </tr>
                                <tr>
                                    <td class="text-muted">Start date</td>
                                    <td>{{ date('j M Y', strtotime($coupon->start_date)) }}</td>
                                </tr>
                                <tr>
                                    <td class="text-muted">End date</td>
                                    <td>{{ date('j M Y', strtotime($coupon->end_date)) }}</td>
                                </tr>
                            </table>

                            <hr>

                            <p class="small text-muted mt-4 mb-2">Coupon Usage</p>
        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('business.market-coupon.update', $coupon->id) }}" enctype="multipart/form-data">
                    @csrf
                        <h4 class="page__subtitle">Edit</h4>
                        <div class="form-group mb-3">
                            <label class="label-control">Name <span class="text-danger">*</span> </label>
                            <input type="text" name="name" placeholder="" class="form-control" value="{{ $coupon->name }}">
                            @error('name') <p class="small text-danger">{{ $message }}</p> @enderror
                        </div>
                        <div class="form-group mb-3">
                            <label class="label-control">Coupon code <span class="text-danger">*</span> </label>
                            <input type="text" name="coupon_code" placeholder="" class="form-control" value="{{ $coupon->coupon_code }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="type" placeholder="" class="form-control" value="{{ $coupon->type }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="amount" placeholder="" class="form-control" value="{{ $coupon->amount }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="max_time_of_use" placeholder="" class="form-control" value="{{ $coupon->max_time_of_use }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="max_time_one_can_use" placeholder="" class="form-control" value="{{ $coupon->max_time_one_can_use }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="start_date" placeholder="" class="form-control" value="{{ date('Y-m-d', strtotime($coupon->start_date)) }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="end_date" placeholder="" class="form-control" value="{{ date('Y-m-d', strtotime($coupon->end_date)) }}">
